...
<!-- Mirrored from separateweb.com/blueket-TM/header-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 30 May 2023 04:20:06 GMT -->
<head>
<meta charset="utf-8" />
...
<div class="menu-subs menu-column-1 sw-hover-2">
<ul>
<li><a href="https://separateweb.com/">Demo 1</a></li>
<li><a href="https://separateweb.com/">Demo 2</a></li>
<li><a href="https://separateweb.com/">Demo 3</a></li>
<li><a href="https://separateweb.com/">Demo 4</a></li>
</ul>
</div>
</li>
<li class="menu-item-has-children">
...
<ul>
<li><a href="#">Static Web Development</a></li>
<li><a href="#">Dynamic Web Development</a></li>
<li><a href="#">Portals, ERP, CRM</a></li>
<li><a href="#">Wordpress Development</a></li>
<li><a href="#">PSD to Website Development</a></li>
</ul>
<h4 class="title">Graphic Designing</h4>
<ul>
<li><a href="#">Logo Designing</a></li>
<li><a href="#">Banners, Flyers Design</a></li>
<li><a href="#">Restaurant/ Bar Menu Card</a></li>
...
<div class="list-item">
<h4 class="title">Technology Consultancy</h4>
<ul>
<li><a href="#">Static Web Development</a></li>
<li><a href="#">Dynamic Web Development</a></li>
<li><a href="#">Portals, ERP, CRM</a></li>
<li><a href="#">Wordpress Development</a></li>
<li><a href="#">PSD to Website Development</a></li>
<li><a href="#">Website Revamping</a></li>
<li><a href="#">Search Engine Optimization</a></li>
<li><a href="#">Social Media Marketing</a></li>
...
<div class="menu-subs menu-column-1 sw-hover-2">
<ul>
<li><a href="service-page-1.html">Service 1</a></li>
<li><a href="service-page-2.html">Service 2</a></li>
</ul>
</div>
</li>
<li class="menu-item-has-children">
...
<a href="#"><i class="fa-solid fa-envelope mr10"></i> <span class="__cf_email__" data-cfemail="472f35073e283235302225342e33226924282a">[email&#160;protected]</span></a>
<a href="#"><i class="fa-solid fa-envelope mr10"></i> <span class="__cf_email__" data-cfemail="c0a9aea6af80b9afb5b2b7a5a2b3a9b4a5eea3afad">[email&#160;protected]</span></a>
</div>
...
<section class="demo-1-hero bkbg0">
<div class="container">
<div class="row">
<div class="col-lg-12">
<div class="hero-content text-center">
<h1 class="mb20 text-gradient-1 h1 wow fadeInUp" data-wow-delay=".2s">We Build Global Experiences That Customers Love</h1>
...
<div class="mt40">
<a href="contact-1.html" class="sw-btn sw-blue-btn wow fadeInUp" data-wow-delay=".6s">Get Started <i class="fa-solid fa-arrow-trend-up"></i></a>
...
<footer class="footer-design-sw pt80 pb30 footerbg1 bkbg2 black-bg-1">
...
<!-- Mirrored from separateweb.com/blueket-TM/header-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 30 May 2023 04:20:07 GMT -->
</html>